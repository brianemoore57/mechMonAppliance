...
_bindMouseWheel: function () {
    ...
    eventHandler[sEventName] = function (eventInfo) {
        ...
        self.option("value", parseFloat(self.options.value, 10) + step); // bem -did have 10 dedimal place parameter not valid!
...
_createValueString: function (value) {
    ...
    var fValue = parseFloat(value, 10); // bem - legal parameter?
